...
class LogIdAfterLoad6
{
    ...
    public function beforeGetById(
        ...
        $this->logger->info("6Logging before retrieving product by ID $productId");
    ...
    public function aroundGetById(
        ...
        $this->logger->info("6Logging around before retrieving product by ID $productId");
        $result = $proceed($productId, $editMode, $storeId, $forceReload);
        //$result = $proceed(...$args);
        $this->logger->info("6Logging around after retrieving product by ID $productId");
    ...
    public function afterGetById(
        ...
        $this->logger->info("6Logging after retrieving product by ID $productId");
